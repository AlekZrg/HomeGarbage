...
<div class=\"setting_window\">
        ...
        <b>Период с: </b><input type=\"date\" form='id_op_inc_period_select' name=\"calendar_from\" value='"; if (isset($_SESSION['calendar_from'])) echo $_SESSION['calendar_from']; else echo date('Y-m-d'); echo "'>
        <b>по: <input type=\"date\" form='id_op_inc_period_select' name=\"calendar_to\" value='"; if (isset($_SESSION['calendar_to'])) echo $_SESSION['calendar_to']; else echo date('Y-m-d'); echo "'></b>
        <a href='javascript: document.op_inc_period_select.submit();' class='set_expenses_func_link'> Показать</a>";
